...
class User(Base):
    ...
    # Relationships
    status_info = relationship("UserStatus", back_populates="user", uselist=False, lazy="selectin")
    fio_info = relationship("FIO", back_populates="user", uselist=False, lazy="selectin")
    health_info = relationship("Health", back_populates="user", uselist=False, lazy="selectin")
    disease_info = relationship("Disease", back_populates="user", uselist=False, lazy="selectin")
